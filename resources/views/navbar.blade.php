<nav class="navbar navbar-expand-lg navbar-dark text-white shadow bg-secondary">

    <h2 class="p-2 text-white" style="font-size:23px; font-weight:400;">Final Project</h2>
